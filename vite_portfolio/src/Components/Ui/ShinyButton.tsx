  ...
  return (
    ...
    >
      <span
        ...
        style={{
          maskImage:
          `linear-gradient(-75deg, ${brightMagenta} calc(var(--x) + 20%), transparent calc(var(--x) + 30%), ${brightMagenta} calc(var(--x) + 100%))`,
      ...
      <span
        style={{
          mask: `linear-gradient(${brightMagenta}, ${brightMagenta}) content-box, linear-gradient(${brightMagenta}, ${brightMagenta})`,
